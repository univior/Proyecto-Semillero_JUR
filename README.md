...
* Dentro de nuestro directorio vamos a encontrar la carpeta:  "runners"  compuesta por la clase llamada "ExecuteServices"; en
  este espacio se podrá visualizar las configuraciones necesarias para ejecutar el feature.
...
* De igual manera contamos con la carpeta:"StepDefinition" compuesta por la clase llamada "ExecuteServicesStepDefinition";
 alli se podrá visualizar el código de todos los Given, When y Then que componen el proyecto.
...
Durante la automatizacion de los modulos trabajados se crearon las diferentes directorios compuestos por clases, las cuales nos ayudaban a manejar el desarrollo de la
automatizacion de forma organizada, dentro de los directorios creados se encuentran los siguientes:
...
se obtienen 10(diez) de imágenes aleatorias de gatos.
...
2. Bajo este modulo se trabajó el método GET, donde por medio de la URL https://api.thecatapi.com/v1/images/search,
   se obtiene la consulta de 1 (una) imágen aleatoria de gatos.
...
Bajo este modulo se trabajó el método POST, donde por medio de la URL https://api.thecatapi.com/v1/favourites y la Api Key,
...
dicha imagen como favorita, obteniendo como response:
...
de Serenity Reports, donde se podrá visualizar los numeros de casos ejecutados con sus correspondientes estados, hora de inicio, hora de finalizacion, tiempo de duracion,
entre otros.
